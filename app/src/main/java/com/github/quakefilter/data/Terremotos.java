...
public class Terremotos {
    public static List<Terremoto> getTerremotosIniciales() {
        ...
        terremotos.add(new Terremoto("11 de marzo de 2011, 14:46", 9.1, "Terremoto y maremoto de Japón de 2011",
                "Costa este de Honshu, Japón", "36°N 140°E", "10"));

        terremotos.add(new Terremoto("28 de febrero de 2010, 06:34", 9.0, "Terremoto de Chile de 2010",
                "Región de Maule, Chile", "35°S 71°W", "15"));

        terremotos.add(new Terremoto("4 de noviembre de 1952, 13:11", 9.0, "Terremoto de Kamchatka de 1952",
                "Kamchatka, Rusia", "52°N 160°E", "25"));

        terremotos.add(new Terremoto("13 de agosto de 1868, 21:30", 9.0, "Terremoto de Arica de 1868",
                "Arica", "18°36′S 71°0′O", "693"));
        ...
        terremotos.add(new Terremoto("27 de febrero de 2010, 03:34", 8.8, "Terremoto de Chile de 2012",
                "Cobquecura, Región del Biobío (actual Ñuble)", "35°50′45.6′′S 72°42′57.6′′O", "525"));
        ...
        terremotos.add(new Terremoto("1 de noviembre de 1755, 10:16", 8.7, "Terremoto de Lisboa de 1755",
                "Lisboa", "36°N 11°O", "60000 a 100000"));
        ...
        terremotos.add(new Terremoto("28 de marzo de 2005, 23:09", 8.6, "Terremoto de Sumatra de 2005",
                "Frente al norte de la isla de Sumatra", "3°30′S 95°30′E", "10"));
        ...
        terremotos.add(new Terremoto("15 de agosto de 1950", 8.6, "Terremoto de Assam de 1950", "Assam (India), Tíbet (China)",
        ...
        terremotos.add(new Terremoto("28 de marzo de 1787, 11:30", 8.6, "Terremoto de Nueva España de 1787",
                "Costas de Oaxaca y Chiapas", "16°N 95°O", "Sin datos"));
